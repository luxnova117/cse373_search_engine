...
public class TestDoubleLinkedList extends BaseTest {
    ...
    public void testDeleteBasic() {
        ...
        list.insert(5, "z");
        this.assertListMatches(new String[] {"x", "a", "y", "b", "c", "z"}, list);
        assertEquals("x", list.delete(0));
        this.assertListMatches(new String[] {"a", "y", "b", "c", "z"}, list);
        assertEquals("z", list.delete(4));
        this.assertListMatches(new String[] {"a", "y", "b", "c"}, list);
        assertEquals("b", list.delete(2));
        this.assertListMatches(new String[] {"a", "y", "c"}, list);
    }
    ...
    @Test(timeout=SECOND)
    public void testDeleteFieldRepairs() {
        IList<String> list1 = new DoubleLinkedList<>();
        list1.add("a");
        list1.add("b");
        list1.add("c");
        list1.delete(1);
        assertEquals(list1.indexOf("a"), 0);
        assertEquals(list1.indexOf("b"), -1);
        assertEquals(list1.indexOf("c"), 1);
        list1.delete(0);
        assertEquals(list1.indexOf("a"), -1);
        assertEquals(list1.indexOf("b"), -1);
        assertEquals(list1.indexOf("c"), 0);
        list1.delete(0);
        assertEquals(list1.indexOf("a"), -1);
        assertEquals(list1.indexOf("b"), -1);
        assertEquals(list1.indexOf("c"), -1);
